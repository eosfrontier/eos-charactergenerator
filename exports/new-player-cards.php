...
<body>
  ...
  from jml_eb_registrants r
    ...
    where v2.field_value = 'Speler' AND r.event_id = 20 and ((r.published = 1 AND (r.payment_method = 'os_ideal' OR r.payment_method = 'os_paypal' OR r.payment_method = 'os_bancontact')) OR
